...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/ClassAsLinkInspector.java
//
...
// class ClassAsLink_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'ClassAsLink_c' to provide 
 ...
 * </p>
 */
public class ClassAsLinkInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public ClassAsLinkInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Association_c result1 = Association_c.getOneR_RELOnR201(ClassInAssociation_c.getOneR_OIROnR203(ReferringClassInAssoc_c.getOneR_RGOOnR205((ClassAsLink_c)arg)));
     if (result1 != null) {
        return result1;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("Associative.gif");
	}
