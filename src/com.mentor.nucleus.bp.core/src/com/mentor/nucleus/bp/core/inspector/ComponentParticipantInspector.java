...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/ComponentParticipantInspector.java
//
...
// class ComponentParticipant_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'ComponentParticipant_c' to provide 
 ...
 * </p>
 */
public class ComponentParticipantInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public ComponentParticipantInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Sequence_c result1 = Sequence_c.getOneSQ_SOnR929(InteractionParticipant_c.getOneSQ_POnR930((ComponentParticipant_c)arg));
     if (result1 != null) {
        return result1;
    }               
    Communication_c result2 = Communication_c.getOneCOMM_COMMOnR1126(ParticipantInCommunication_c.getOneCOMM_PICOnR1126(InteractionParticipant_c.getOneSQ_POnR930((ComponentParticipant_c)arg)));
     if (result2 != null) {
        return result2;
    }               
    Package_c result3 = Package_c.getOneEP_PKGOnR8000(PackageableElement_c.getOnePE_PEOnR8001(InteractionParticipant_c.getOneSQ_POnR930((ComponentParticipant_c)arg)));
     if (result3 != null) {
        return result3;
    }               
...
;
  ...
  public Object[] getReferentialDetails(Class<?> referentialClass, Object arg) {
	...
	if(details[0] == null && referentialClass == Component_c.class) {
		details[0] = Component_c.getOneC_COnR955(
(ComponentParticipant_c)arg)
;
  ...
  */
  public ObjectElement[] getReferentials(Object arg) {
     List<ObjectElement> referentials = new ArrayList<ObjectElement>();
        Object referential = Component_c.getOneC_COnR955(
(ComponentParticipant_c)arg)

;
     referentials.add(new ObjectElement ("referential_Formal_Component", ObjectElement.REFERENTIAL_ATTRIBUTE_ELEMENT, referential, arg, false));
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[6];
      attrSet[0] = new ObjectElement("InformalComponentName", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getInformalcomponentname"), arg, "getInformalcomponentname", true);
