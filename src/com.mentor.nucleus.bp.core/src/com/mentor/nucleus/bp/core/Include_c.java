...
//====================================================================
//
// File:      com.mentor.nucleus.bp.core.Include_c.java
//
...
abstract class EV_INCLUDE extends genericEvent_c {
	public abstract int getEvtcode();
}

public class Include_c extends NonRootModelElement
		implements
			IAdaptable,
			Cloneable {
	// Public Constructors
	public Include_c(ModelRoot modelRoot, java.util.UUID p_m_assoc_id,
			String p_m_descrip) {
		super(modelRoot);
	...
	static public Include_c createProxy(ModelRoot modelRoot,
		...
		InstanceList instances = modelRoot.getInstanceList(Include_c.class);
		Include_c new_inst = null;
		synchronized (instances) {
			Object[] key = {p_m_assoc_id};
			new_inst = (Include_c) instances.get(key);
		}
		...
		if (new_inst == null) {
			...
			new_inst = new Include_c(modelRoot, p_m_assoc_id, p_m_descrip);
			new_inst.m_contentPath = contentPath;
		}
		return new_inst;
	}

	static public Include_c resolveInstance(ModelRoot modelRoot,
			java.util.UUID p_m_assoc_id, String p_m_descrip) {
		InstanceList instances = modelRoot.getInstanceList(Include_c.class);
		Include_c source = null;
		synchronized (instances) {
			Object[] key = {p_m_assoc_id};
			source = (Include_c) instances.get(key);
		...
		Include_c new_inst = new Include_c(modelRoot, p_m_assoc_id, p_m_descrip);
		return new_inst;
	}
	public Include_c(ModelRoot modelRoot) {
		super(modelRoot);
		m_descrip = "";
	...
	public boolean cachedIdentityEquals(Object elem) {
		...
		if (!getAssoc_idCachedValue().equals(
				((Include_c) elem).getAssoc_idCachedValue()))
			return false;
		return true;
	}
			...
			if (IsSupertypeUseCaseAssociation != null) {
				...
				if (Boolean.valueOf(System.getenv("PTC_MCC_ENABLED")) == true) { //$NON-NLS-1$
					Ooaofooa.log
							.println(
									ILogger.CONSISTENCY,
									"Include_c.relateAcrossR1210To(UseCaseAssociation_c target)",
									"Relate performed across R1210 from Include to Use Case Association without unrelate of prior instance.");
				}
			}
	...
	public static Include_c getOneUC_IOnR1210(UseCaseAssociation_c[] targets) {
		return getOneUC_IOnR1210(targets, null);
	}

	public static Include_c getOneUC_IOnR1210(UseCaseAssociation_c[] targets,
			ClassQueryInterface_c test) {
		Include_c ret_val = null;
		if (targets != null) {
			for (int i = 0; i < targets.length && ret_val == null; ++i) {
				ret_val = getOneUC_IOnR1210(targets[i], test);
			}
		}
	...
	public static Include_c getOneUC_IOnR1210(UseCaseAssociation_c target) {
		return getOneUC_IOnR1210(target, null);
	}

	public static Include_c getOneUC_IOnR1210(UseCaseAssociation_c target,
			boolean loadComponent) {
		return getOneUC_IOnR1210(target.getModelRoot(), target, null,
				loadComponent);
	}
	...
	public static Include_c getOneUC_IOnR1210(UseCaseAssociation_c target,
			ClassQueryInterface_c test) {
		if (target != null) {
			return getOneUC_IOnR1210(target.getModelRoot(), target, test);
		}
		return null;
	}

	public static Include_c getOneUC_IOnR1210(ModelRoot modelRoot,
			UseCaseAssociation_c target, ClassQueryInterface_c test) {
		return getOneUC_IOnR1210(modelRoot, target, test, true);
	}

	public static Include_c getOneUC_IOnR1210(ModelRoot modelRoot,
			UseCaseAssociation_c target, ClassQueryInterface_c test,
			boolean loadComponent) {
		return find_getOneUC_IOnR1210(modelRoot, target, test);
	}
	private static Include_c find_getOneUC_IOnR1210(ModelRoot modelRoot,
			UseCaseAssociation_c target, ClassQueryInterface_c test) {
		if (target != null) {
			Include_c source = (Include_c) target.backPointer_IsSubtypeIncludeIsSubtype_R1210;
	...
	public static Include_c[] getManyUC_IsOnR1210(UseCaseAssociation_c[] targets) {
		return getManyUC_IsOnR1210(targets, null);
	}
	public static Include_c[] getManyUC_IsOnR1210(
			UseCaseAssociation_c[] targets, boolean loadComponent) {
		return getManyUC_IsOnR1210(targets, null, loadComponent);
	}
	public static Include_c[] getManyUC_IsOnR1210(
			UseCaseAssociation_c[] targets, ClassQueryInterface_c test) {
		return getManyUC_IsOnR1210(targets, test, true);
	}
	...
	public static Include_c[] getManyUC_IsOnR1210(
		...
		for (int i = 0; i < targets.length; i++) {
			Include_c source = (Include_c) targets[i].backPointer_IsSubtypeIncludeIsSubtype_R1210;
			if (source != null && (test == null || test.evaluate(source))) {
				matches.add(source);
			}
		}
		if (matches.size() > 0) {
			Include_c[] ret_set = new Include_c[matches.size()];
	...
	public static Include_c[] getManyUC_IsOnR1210(UseCaseAssociation_c target) {
		if (target != null) {
			UseCaseAssociation_c[] targetArray = new UseCaseAssociation_c[1];
			targetArray[0] = target;
			return getManyUC_IsOnR1210(targetArray);
		} else {
			Include_c[] result = new Include_c[0];
			return result;
		}
	}
	...
	public static Include_c[] getManyUC_IsOnR1210(UseCaseAssociation_c target,
		...
		if (target != null) {
			UseCaseAssociation_c[] targetArray = new UseCaseAssociation_c[1];
			targetArray[0] = target;
			return getManyUC_IsOnR1210(targetArray, loadComponent);
		} else {
			Include_c[] result = new Include_c[0];
			return result;
		}
	...
	public static void batchRelateAll(ModelRoot modelRoot, boolean notifyChanges, boolean searchAllRoots, boolean relateProxies)
  {
    ...
    synchronized(instances) {
	    ...
	    {
            final Include_c inst = (Include_c)cursor.next() ;
	...
	public static Include_c IncludeInstance(ModelRoot modelRoot,
			ClassQueryInterface_c test, boolean loadComponent) {
		Include_c result = findIncludeInstance(modelRoot, test, loadComponent);
			...
			for (int i = 0; i < pmcs.size(); i++) {
				...
				if (!component.isLoaded()) {
					try {
						...
						result = findIncludeInstance(modelRoot, test,
								loadComponent);
						if (result != null)
							return result;
					} catch (Exception e) {
	...
	private static Include_c findIncludeInstance(ModelRoot modelRoot,
			ClassQueryInterface_c test, boolean loadComponent) {
		InstanceList instances = modelRoot.getInstanceList(Include_c.class);
		synchronized (instances) {
			for (int i = 0; i < instances.size(); ++i) {
				Include_c x = (Include_c) instances.get(i);
	...
	public static Include_c IncludeInstance(ModelRoot modelRoot,
			ClassQueryInterface_c test) {
		return IncludeInstance(modelRoot, test, true);
	}

	public static Include_c IncludeInstance(ModelRoot modelRoot) {
		return IncludeInstance(modelRoot, null, true);
	}

	public static Include_c[] IncludeInstances(ModelRoot modelRoot,
			ClassQueryInterface_c test, boolean loadComponent) {
		if (loadComponent) {
	...
	public static Include_c[] IncludeInstances(ModelRoot modelRoot,
			ClassQueryInterface_c test) {
		return IncludeInstances(modelRoot, test, true);
	}
	public static Include_c[] IncludeInstances(ModelRoot modelRoot) {
		return IncludeInstances(modelRoot, null, true);
	}

	public boolean delete() {
		boolean result = super.delete();
		boolean delete_error = false;
		String errorMsg = "The following relationships were not torn down by the Include.dispose call: ";
		UseCaseAssociation_c testR1210Inst3 = UseCaseAssociation_c
		...
		if (delete_error == true) {
			...
			if (CorePlugin.getDefault().isDebugging()) {
				Ooaofooa.log.println(ILogger.DELETE, "Include", errorMsg);
			} else {
				Exception e = new Exception();
				e.fillInStackTrace();
	...
	public static void checkClassConsistency(ModelRoot modelRoot) {
		Ooaofooa.log.println(ILogger.OPERATION, "Include", //$NON-NLS-1$
				" Operation entered: Include::checkClassConsistency"); //$NON-NLS-1$
		if (Boolean.valueOf(System.getenv("PTC_MCC_ENABLED")) == false) { //$NON-NLS-1$
			return;
		}
		Include_c[] objs = Include_c.IncludeInstances(modelRoot, null, false);
	...
	public boolean checkConsistency() {
		Ooaofooa.log.println(ILogger.OPERATION, "Include", //$NON-NLS-1$
				" Operation entered: Include::checkConsistency"); //$NON-NLS-1$
		if (Boolean.valueOf(System.getenv("PTC_MCC_ENABLED")) == false) { //$NON-NLS-1$
			return true;
		}
	...
	public void Dispose() {
		Ooaofooa.log.println(ILogger.OPERATION, "Include",
				" Operation entered: Include::Dispose");
	...
	public int Get_style(final int p_At) {
		Ooaofooa.log.println(ILogger.OPERATION, "Include",
				" Operation entered: Include::Get_style");
		final ModelRoot modelRoot = getModelRoot();
		if ((p_At == End_c.End)) {
	...
	public String Get_connector_text(final java.util.UUID p_Obj_id,
		...
		Ooaofooa.log.println(ILogger.OPERATION, "Include",
				" Operation entered: Include::Get_connector_text");
		final ModelRoot modelRoot = getModelRoot();
	...
	public java.util.UUID Get_ooa_id() {
		Ooaofooa.log.println(ILogger.OPERATION, "Include",
				" Operation entered: Include::Get_ooa_id");
		final ModelRoot modelRoot = getModelRoot();
		return getAssoc_id();
	...
	public String Get_name() {
		Ooaofooa.log.println(ILogger.OPERATION, "Include",
				" Operation entered: Include::Get_name");
		final ModelRoot modelRoot = getModelRoot();
		return "";
