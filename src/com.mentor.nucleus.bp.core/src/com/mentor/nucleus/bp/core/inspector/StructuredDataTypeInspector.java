...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/StructuredDataTypeInspector.java
//
...
// class StructuredDataType_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'StructuredDataType_c' to provide 
 ...
 * </p>
 */
public class StructuredDataTypeInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public StructuredDataTypeInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    DataTypePackage_c result1 = DataTypePackage_c.getOneS_DPKOnR39(DataTypeInPackage_c.getOneS_DIPOnR39(DataType_c.getOneS_DTOnR17((StructuredDataType_c)arg)));
     if (result1 != null) {
        return result1;
    }               
    Package_c result2 = Package_c.getOneEP_PKGOnR8000(PackageableElement_c.getOnePE_PEOnR8001(DataType_c.getOneS_DTOnR17((StructuredDataType_c)arg)));
     if (result2 != null) {
        return result2;
    }               
...
(StructuredDataType_c)arg)
;



    sort(v_datatype);
    StructureMember_c [] v_structuremember = 
...
;
    ...
    for (int i = 0 ; i < v_structuremember.length ; i++) {   
        result.add(new ObjectElement("v_structuremember", ObjectElement.RELATION_ROLE_ELEMENT, v_structuremember[i], arg, false));
    }
...
;
    ...
    if (v_structuremember.length > 0) return true;
    return false;
  }
