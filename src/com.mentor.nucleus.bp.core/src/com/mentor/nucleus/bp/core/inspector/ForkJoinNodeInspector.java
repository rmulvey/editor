...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/ForkJoinNodeInspector.java
//
...
// class ForkJoinNode_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'ForkJoinNode_c' to provide 
 ...
 * </p>
 */
public class ForkJoinNodeInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public ForkJoinNodeInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Activity_c result1 = Activity_c.getOneA_AOnR1101(ActivityNode_c.getOneA_NOnR1105(ControlNode_c.getOneA_CTLOnR1106((ForkJoinNode_c)arg)));
     if (result1 != null) {
        return result1;
    }               
    Package_c result2 = Package_c.getOneEP_PKGOnR8000(PackageableElement_c.getOnePE_PEOnR8001(ActivityNode_c.getOneA_NOnR1105(ControlNode_c.getOneA_CTLOnR1106((ForkJoinNode_c)arg))));
     if (result2 != null) {
        return result2;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[3];
      ...
      attrSet[1] = new ObjectElement("GuardCondition", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getGuardcondition"), arg, "getGuardcondition", true);
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("ForkJoinNode.gif");
	}
