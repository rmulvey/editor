...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/ReferentialAttributeInspector.java
//
...
// class ReferentialAttribute_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'ReferentialAttribute_c' to provide 
 ...
 * </p>
 */
public class ReferentialAttributeInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public ReferentialAttributeInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Attribute_c result1 = Attribute_c.getOneO_ATTROnR106((ReferentialAttribute_c)arg);
     if (result1 != null) {
        return result1;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[7];
      attrSet[0] = new ObjectElement("Ref_Mode", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getRef_mode"), arg, "getRef_mode", true);
      attrSet[1] = new ObjectElement("BaseAttrName", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getBaseattrname"), arg, "getBaseattrname", true);
