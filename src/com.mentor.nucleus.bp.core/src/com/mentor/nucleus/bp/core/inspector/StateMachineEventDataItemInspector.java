...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/StateMachineEventDataItemInspector.java
//
...
// class StateMachineEventDataItem_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'StateMachineEventDataItem_c' to provide 
 ...
 * </p>
 */
public class StateMachineEventDataItemInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public StateMachineEventDataItemInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    StateMachineEvent_c result1 = StateMachineEvent_c.getOneSM_EVTOnR532((StateMachineEventDataItem_c)arg);
     if (result1 != null) {
        return result1;
    }               
  ...
  public Object[] getReferentialDetails(Class<?> referentialClass, Object arg) {
	...
	if(details[0] == null && referentialClass == DataType_c.class) {
		details[0] = DataType_c.getOneS_DTOnR524(
(StateMachineEventDataItem_c)arg)
;
  ...
  */
  public ObjectElement[] getReferentials(Object arg) {
     List<ObjectElement> referentials = new ArrayList<ObjectElement>();
        Object referential = DataType_c.getOneS_DTOnR524(
(StateMachineEventDataItem_c)arg)
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("EventData.gif");
	}
