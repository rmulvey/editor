...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/InstanceAttributeValueInspector.java
//
...
// class InstanceAttributeValue_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'InstanceAttributeValue_c' to provide 
 ...
 * </p>
 */
public class InstanceAttributeValueInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public InstanceAttributeValueInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    ClassInstanceParticipant_c result1 = ClassInstanceParticipant_c.getOneSQ_CIPOnR936(InstanceAttributeValue_c.getOneSQ_AVOnR948(InformalAttributeValue_c.getOneSQ_IAVOnR948((InstanceAttributeValue_c)arg)));
     if (result1 != null) {
        return result1;
    }               
