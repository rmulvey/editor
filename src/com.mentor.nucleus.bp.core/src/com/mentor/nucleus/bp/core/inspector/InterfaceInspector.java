...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/InterfaceInspector.java
//
...
// class Interface_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'Interface_c' to provide 
 ...
 * </p>
 */
public class InterfaceInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public InterfaceInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Component_c result1 = Component_c.getOneC_COnR8003(PackageableElement_c.getOnePE_PEOnR8001((Interface_c)arg));
     if (result1 != null) {
        return result1;
    }               
    InterfacePackage_c result2 = InterfacePackage_c.getOneIP_IPOnR4303((Interface_c)arg);
     if (result2 != null) {
        return result2;
    }               
    Package_c result3 = Package_c.getOneEP_PKGOnR8000(PackageableElement_c.getOnePE_PEOnR8001((Interface_c)arg));
     if (result3 != null) {
        return result3;
    }               
  ...
  public ObjectElement[] getChildRelations(Object arg) {
    int resultSize = 0;
    InterfaceOperation_c [] v_operations = 
InterfaceOperation_c.getManyC_IOsOnR4004(
...
;
    ...
    sort(v_operations);
    InterfaceSignal_c [] v_signals = 
InterfaceSignal_c.getManyC_ASsOnR4004(
ExecutableProperty_c.getManyC_EPsOnR4003(
(Interface_c)arg)
)
;
    ...
    for (int i = 0 ; i < v_operations.length ; i++) {   
        result.add(new ObjectElement("v_operations", ObjectElement.RELATION_ROLE_ELEMENT, v_operations[i], arg, false));
    }
    for (int i = 0 ; i < v_signals.length ; i++) {   
        result.add(new ObjectElement("v_signals", ObjectElement.RELATION_ROLE_ELEMENT, v_signals[i], arg, false));
    }
...
;
    ...
    if (v_operations.length > 0) return true;
    InterfaceSignal_c [] v_signals = 
InterfaceSignal_c.getManyC_ASsOnR4004(
ExecutableProperty_c.getManyC_EPsOnR4003(
(Interface_c)arg)
...
;
    ...
    if (v_signals.length > 0) return true;
    return false;
  }
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("Interface.gif");
	}
