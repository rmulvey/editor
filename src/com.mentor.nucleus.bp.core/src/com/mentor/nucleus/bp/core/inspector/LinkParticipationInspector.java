...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/LinkParticipationInspector.java
//
...
// class LinkParticipation_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'LinkParticipation_c' to provide 
 ...
 * </p>
 */
public class LinkParticipationInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public LinkParticipationInspector(MetadataSortingManager sortingManager){
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[4];
      attrSet[0] = new ObjectElement("Label", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getLabel"), arg, "getLabel", true);
