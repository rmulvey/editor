...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/CreationTransitionInspector.java
//
...
// class CreationTransition_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'CreationTransition_c' to provide 
 ...
 * </p>
 */
public class CreationTransitionInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public CreationTransitionInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    InstanceStateMachine_c result1 = InstanceStateMachine_c.getOneSM_ISMOnR517(StateMachine_c.getOneSM_SMOnR505(Transition_c.getOneSM_TXNOnR507((CreationTransition_c)arg)));
     if (result1 != null) {
        return result1;
    }               
