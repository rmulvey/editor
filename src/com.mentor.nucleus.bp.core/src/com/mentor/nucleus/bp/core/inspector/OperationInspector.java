...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/OperationInspector.java
//
...
// class Operation_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'Operation_c' to provide 
 ...
 * </p>
 */
public class OperationInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public OperationInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    ModelClass_c result1 = ModelClass_c.getOneO_OBJOnR115((Operation_c)arg);
     if (result1 != null) {
        return result1;
    }               
  ...
  public ObjectElement[] getChildRelations(Object arg) {
    int resultSize = 0;
    OperationParameter_c [] v_operationparameter = 
...
;
    ...
    sort(v_operationparameter);
    List<ObjectElement> result = new ArrayList<ObjectElement> ();
    for (int i = 0 ; i < v_operationparameter.length ; i++) {   
        result.add(new ObjectElement("v_operationparameter", ObjectElement.RELATION_ROLE_ELEMENT, v_operationparameter[i], arg, false));
    }
...
;
    ...
    if (v_operationparameter.length > 0) return true;
    return false;
  }
  ...
  public Object[] getReferentialDetails(Class<?> referentialClass, Object arg) {
	...
	if(details[0] == null && referentialClass == DataType_c.class) {
		details[0] = DataType_c.getOneS_DTOnR116(
(Operation_c)arg)
;
  ...
  */
  public ObjectElement[] getReferentials(Object arg) {
     List<ObjectElement> referentials = new ArrayList<ObjectElement>();
        Object referential = DataType_c.getOneS_DTOnR116(
(Operation_c)arg)
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[11];
      ...
      attrSet[2] = new ObjectElement("Instance_Based", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getInstance_based"), arg, "getInstance_based", true);
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("Operation.gif");
	}
