...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/BinaryAssociationInspector.java
//
...
// class BinaryAssociation_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'BinaryAssociation_c' to provide 
 ...
 * </p>
 */
public class BinaryAssociationInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public BinaryAssociationInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Package_c result1 = Package_c.getOneEP_PKGOnR8000(PackageableElement_c.getOnePE_PEOnR8001(UseCaseAssociation_c.getOneUC_UCAOnR1210((BinaryAssociation_c)arg)));
     if (result1 != null) {
        return result1;
    }               
  ...
  */
  public ObjectElement[] getReferentials(Object arg) {
     List<ObjectElement> referentials = new ArrayList<ObjectElement>();
        Object referential = ActorParticipant_c.getOneSQ_APOnR930(
InteractionParticipant_c.getOneSQ_POnR1206(
UseCaseAssociation_c.getOneUC_UCAOnR1210(
(BinaryAssociation_c)arg)
)
