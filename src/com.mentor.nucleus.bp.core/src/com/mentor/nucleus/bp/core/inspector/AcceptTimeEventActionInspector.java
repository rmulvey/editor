...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/AcceptTimeEventActionInspector.java
//
...
// class AcceptTimeEventAction_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'AcceptTimeEventAction_c' to provide 
 ...
 * </p>
 */
public class AcceptTimeEventActionInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public AcceptTimeEventActionInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Activity_c result1 = Activity_c.getOneA_AOnR1101(ActivityNode_c.getOneA_NOnR1105(ActionNode_c.getOneA_ACTOnR1107(AcceptEvent_c.getOneA_AEOnR1112((AcceptTimeEventAction_c)arg))));
     if (result1 != null) {
        return result1;
    }               
    Package_c result2 = Package_c.getOneEP_PKGOnR8000(PackageableElement_c.getOnePE_PEOnR8001(ActivityNode_c.getOneA_NOnR1105(ActionNode_c.getOneA_ACTOnR1107(AcceptEvent_c.getOneA_AEOnR1112((AcceptTimeEventAction_c)arg)))));
     if (result2 != null) {
        return result2;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("AcceptTimeEvent.gif");
	}
