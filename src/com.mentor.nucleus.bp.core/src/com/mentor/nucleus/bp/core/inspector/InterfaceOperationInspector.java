...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/InterfaceOperationInspector.java
//
...
// class InterfaceOperation_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'InterfaceOperation_c' to provide 
 ...
 * </p>
 */
public class InterfaceOperationInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public InterfaceOperationInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Interface_c result1 = Interface_c.getOneC_IOnR4003(ExecutableProperty_c.getOneC_EPOnR4004((InterfaceOperation_c)arg));
     if (result1 != null) {
        return result1;
    }               
...
;
  ...
  public Object[] getReferentialDetails(Class<?> referentialClass, Object arg) {
	...
	if(details[0] == null && referentialClass == DataType_c.class) {
		details[0] = DataType_c.getOneS_DTOnR4008(
(InterfaceOperation_c)arg)
;
  ...
  */
  public ObjectElement[] getReferentials(Object arg) {
     List<ObjectElement> referentials = new ArrayList<ObjectElement>();
        Object referential = DataType_c.getOneS_DTOnR4008(
(InterfaceOperation_c)arg)
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[7];
      ...
      attrSet[3] = new ObjectElement("Return_Dimensions", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getReturn_dimensions"), arg, "getReturn_dimensions", true);
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("InterfaceOperation.gif");
	}
