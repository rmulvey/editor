...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/NewBaseAttributeInspector.java
//
...
// class NewBaseAttribute_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'NewBaseAttribute_c' to provide 
 ...
 * </p>
 */
public class NewBaseAttributeInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public NewBaseAttributeInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Attribute_c result1 = Attribute_c.getOneO_ATTROnR106(BaseAttribute_c.getOneO_BATTROnR107((NewBaseAttribute_c)arg));
     if (result1 != null) {
        return result1;
    }               
