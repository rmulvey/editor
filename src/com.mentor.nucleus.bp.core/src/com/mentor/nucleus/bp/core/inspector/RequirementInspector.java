...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/RequirementInspector.java
//
...
// class Requirement_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'Requirement_c' to provide 
 ...
 * </p>
 */
public class RequirementInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public RequirementInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Port_c result1 = Port_c.getOneC_POOnR4016(InterfaceReference_c.getOneC_IROnR4009((Requirement_c)arg));
     if (result1 != null) {
        return result1;
    }               
    Satisfaction_c result2 = Satisfaction_c.getOneC_SFOnR4002((Requirement_c)arg);
     if (result2 != null) {
        return result2;
    }               
  ...
  public ObjectElement[] getChildRelations(Object arg) {
    int resultSize = 0;
    RequiredOperation_c [] v_requiredinterfaceoperations = 
RequiredOperation_c.getManySPR_ROsOnR4502(
...
;
    ...
    sort(v_requiredinterfaceoperations);
    RequiredSignal_c [] v_requiredinterfacesignals = 
RequiredSignal_c.getManySPR_RSsOnR4502(
RequiredExecutableProperty_c.getManySPR_REPsOnR4500(
(Requirement_c)arg)
)
;
    ...
    sort(v_requiredinterfacesignals);
    Delegation_c [] v_delegatedinterfacesDelegatedRequiredInterfaces = 
...
;
    ...
    sort(v_delegatedinterfacesDelegatedRequiredInterfaces);
    List<ObjectElement> result = new ArrayList<ObjectElement> ();
    for (int i = 0 ; i < v_requiredinterfaceoperations.length ; i++) {   
        result.add(new ObjectElement("v_requiredinterfaceoperations", ObjectElement.RELATION_ROLE_ELEMENT, v_requiredinterfaceoperations[i], arg, false));
    }
    for (int i = 0 ; i < v_requiredinterfacesignals.length ; i++) {   
        result.add(new ObjectElement("v_requiredinterfacesignals", ObjectElement.RELATION_ROLE_ELEMENT, v_requiredinterfacesignals[i], arg, false));
    }
    for (int i = 0 ; i < v_delegatedinterfacesDelegatedRequiredInterfaces.length ; i++) {   
        result.add(new ObjectElement("v_delegatedinterfacesDelegatedRequiredInterfaces", ObjectElement.RELATION_ROLE_ELEMENT, v_delegatedinterfacesDelegatedRequiredInterfaces[i], arg, false));
    }
...
;
    ...
    if (v_requiredinterfaceoperations.length > 0) return true;
    RequiredSignal_c [] v_requiredinterfacesignals = 
RequiredSignal_c.getManySPR_RSsOnR4502(
RequiredExecutableProperty_c.getManySPR_REPsOnR4500(
(Requirement_c)arg)
...
;
    ...
    if (v_requiredinterfacesignals.length > 0) return true;
    Delegation_c [] v_delegatedinterfacesDelegatedRequiredInterfaces = 
Delegation_c.getManyC_DGsOnR4013(
InterfaceReferenceInDelegation_c.getManyC_RIDsOnR4013(
InterfaceReference_c.getManyC_IRsOnR4009(
...
;
    ...
    if (v_delegatedinterfacesDelegatedRequiredInterfaces.length > 0) return true;
    return false;
  }
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("Requirement.gif");
	}
