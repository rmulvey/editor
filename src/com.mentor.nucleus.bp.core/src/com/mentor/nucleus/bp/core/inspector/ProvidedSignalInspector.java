...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/ProvidedSignalInspector.java
//
...
// class ProvidedSignal_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'ProvidedSignal_c' to provide 
 ...
 * </p>
 */
public class ProvidedSignalInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public ProvidedSignalInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Provision_c result1 = Provision_c.getOneC_POnR4501(ProvidedExecutableProperty_c.getOneSPR_PEPOnR4503((ProvidedSignal_c)arg));
     if (result1 != null) {
        return result1;
    }               
    ImportedProvision_c result2 = ImportedProvision_c.getOneCL_IPOnR4703(ImportedReference_c.getOneCL_IIROnR4701(InterfaceReference_c.getOneC_IROnR4009(Provision_c.getOneC_POnR4501(ProvidedExecutableProperty_c.getOneSPR_PEPOnR4503((ProvidedSignal_c)arg)))));
     if (result2 != null) {
        return result2;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("ProvidedSignal.gif");
	}
