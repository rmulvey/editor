...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/ProvidedOperationInspector.java
//
...
// class ProvidedOperation_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'ProvidedOperation_c' to provide 
 ...
 * </p>
 */
public class ProvidedOperationInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public ProvidedOperationInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Provision_c result1 = Provision_c.getOneC_POnR4501(ProvidedExecutableProperty_c.getOneSPR_PEPOnR4503((ProvidedOperation_c)arg));
     if (result1 != null) {
        return result1;
    }               
    ImportedProvision_c result2 = ImportedProvision_c.getOneCL_IPOnR4703(ImportedReference_c.getOneCL_IIROnR4701(InterfaceReference_c.getOneC_IROnR4009(Provision_c.getOneC_POnR4501(ProvidedExecutableProperty_c.getOneSPR_PEPOnR4503((ProvidedOperation_c)arg)))));
     if (result2 != null) {
        return result2;
    }               
...
ExecutableProperty_c.getManyC_EPsOnR4501(
ProvidedExecutableProperty_c.getManySPR_PEPsOnR4503(
(ProvidedOperation_c)arg)
)
)
;
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("ProvidedOperation.gif");
	}
