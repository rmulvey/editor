...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/DerivedBaseAttributeInspector.java
//
...
// class DerivedBaseAttribute_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'DerivedBaseAttribute_c' to provide 
 ...
 * </p>
 */
public class DerivedBaseAttributeInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public DerivedBaseAttributeInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Attribute_c result1 = Attribute_c.getOneO_ATTROnR106(BaseAttribute_c.getOneO_BATTROnR107((DerivedBaseAttribute_c)arg));
     if (result1 != null) {
        return result1;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[5];
      attrSet[0] = new ObjectElement("Action_Semantics", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getAction_semantics"), arg, "getAction_semantics", true);
      attrSet[0].setDerived();
      attrSet[1] = new ObjectElement("Suc_Pars", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getSuc_pars"), arg, "getSuc_pars", true);
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("DerivedAttribute.gif");
	}
