...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/FunctionParameterInspector.java
//
...
// class FunctionParameter_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'FunctionParameter_c' to provide 
 ...
 * </p>
 */
public class FunctionParameterInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public FunctionParameterInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Function_c result1 = Function_c.getOneS_SYNCOnR24((FunctionParameter_c)arg);
     if (result1 != null) {
        return result1;
    }               
  ...
  public Object[] getReferentialDetails(Class<?> referentialClass, Object arg) {
	...
	if(details[0] == null && referentialClass == DataType_c.class) {
		details[0] = DataType_c.getOneS_DTOnR26(
(FunctionParameter_c)arg)
;
  ...
  */
  public ObjectElement[] getReferentials(Object arg) {
     List<ObjectElement> referentials = new ArrayList<ObjectElement>();
        Object referential = DataType_c.getOneS_DTOnR26(
(FunctionParameter_c)arg)
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("FunctionParameter.gif");
	}
