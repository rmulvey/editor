...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/UseCaseParticipantInspector.java
//
...
// class UseCaseParticipant_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'UseCaseParticipant_c' to provide 
 ...
 * </p>
 */
public class UseCaseParticipantInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public UseCaseParticipantInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    UseCaseDiagram_c result1 = UseCaseDiagram_c.getOneUC_UCCOnR1203(ParticipantInUseCase_c.getOneUC_PIUCOnR1203(InteractionParticipant_c.getOneSQ_POnR930((UseCaseParticipant_c)arg)));
     if (result1 != null) {
        return result1;
    }               
    Package_c result2 = Package_c.getOneEP_PKGOnR8000(PackageableElement_c.getOnePE_PEOnR8001(InteractionParticipant_c.getOneSQ_POnR930((UseCaseParticipant_c)arg)));
     if (result2 != null) {
        return result2;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("UseCase.gif");
	}
