...
//====================================================================
//
// File:      com.mentor.nucleus.bp.core.Extend_c.java
//
...
abstract class EV_EXTEND extends genericEvent_c {
	public abstract int getEvtcode();
}

public class Extend_c extends NonRootModelElement
		implements
			IAdaptable,
			Cloneable {
	// Public Constructors
	public Extend_c(ModelRoot modelRoot, java.util.UUID p_m_assoc_id,
			String p_m_descrip) {
		super(modelRoot);
	...
	static public Extend_c createProxy(ModelRoot modelRoot,
		...
		InstanceList instances = modelRoot.getInstanceList(Extend_c.class);
		Extend_c new_inst = null;
		synchronized (instances) {
			Object[] key = {p_m_assoc_id};
			new_inst = (Extend_c) instances.get(key);
		}
		...
		if (new_inst == null) {
			...
			new_inst = new Extend_c(modelRoot, p_m_assoc_id, p_m_descrip);
			new_inst.m_contentPath = contentPath;
		}
		return new_inst;
	}

	static public Extend_c resolveInstance(ModelRoot modelRoot,
			java.util.UUID p_m_assoc_id, String p_m_descrip) {
		InstanceList instances = modelRoot.getInstanceList(Extend_c.class);
		Extend_c source = null;
		synchronized (instances) {
			Object[] key = {p_m_assoc_id};
			source = (Extend_c) instances.get(key);
		...
		Extend_c new_inst = new Extend_c(modelRoot, p_m_assoc_id, p_m_descrip);
		return new_inst;
	}
	public Extend_c(ModelRoot modelRoot) {
		super(modelRoot);
		m_descrip = "";
	...
	public boolean cachedIdentityEquals(Object elem) {
		...
		if (!getAssoc_idCachedValue().equals(
				((Extend_c) elem).getAssoc_idCachedValue()))
			return false;
		return true;
	}
			...
			if (IsSupertypeUseCaseAssociation != null) {
				...
				if (Boolean.valueOf(System.getenv("PTC_MCC_ENABLED")) == true) { //$NON-NLS-1$
					Ooaofooa.log
							.println(
									ILogger.CONSISTENCY,
									"Extend_c.relateAcrossR1210To(UseCaseAssociation_c target)",
									"Relate performed across R1210 from Extend to Use Case Association without unrelate of prior instance.");
				}
			}
	...
	public static Extend_c getOneUC_EOnR1210(UseCaseAssociation_c[] targets) {
		return getOneUC_EOnR1210(targets, null);
	}

	public static Extend_c getOneUC_EOnR1210(UseCaseAssociation_c[] targets,
			ClassQueryInterface_c test) {
		Extend_c ret_val = null;
		if (targets != null) {
			for (int i = 0; i < targets.length && ret_val == null; ++i) {
				ret_val = getOneUC_EOnR1210(targets[i], test);
			}
		}
	...
	public static Extend_c getOneUC_EOnR1210(UseCaseAssociation_c target) {
		return getOneUC_EOnR1210(target, null);
	}

	public static Extend_c getOneUC_EOnR1210(UseCaseAssociation_c target,
			boolean loadComponent) {
		return getOneUC_EOnR1210(target.getModelRoot(), target, null,
				loadComponent);
	}
	...
	public static Extend_c getOneUC_EOnR1210(UseCaseAssociation_c target,
			ClassQueryInterface_c test) {
		if (target != null) {
			return getOneUC_EOnR1210(target.getModelRoot(), target, test);
		}
		return null;
	}

	public static Extend_c getOneUC_EOnR1210(ModelRoot modelRoot,
			UseCaseAssociation_c target, ClassQueryInterface_c test) {
		return getOneUC_EOnR1210(modelRoot, target, test, true);
	}

	public static Extend_c getOneUC_EOnR1210(ModelRoot modelRoot,
			UseCaseAssociation_c target, ClassQueryInterface_c test,
			boolean loadComponent) {
		return find_getOneUC_EOnR1210(modelRoot, target, test);
	}
	private static Extend_c find_getOneUC_EOnR1210(ModelRoot modelRoot,
			UseCaseAssociation_c target, ClassQueryInterface_c test) {
		if (target != null) {
			Extend_c source = (Extend_c) target.backPointer_IsSubtypeExtendIsSubtype_R1210;
	...
	public static Extend_c[] getManyUC_EsOnR1210(UseCaseAssociation_c[] targets) {
		return getManyUC_EsOnR1210(targets, null);
	}
	public static Extend_c[] getManyUC_EsOnR1210(
			UseCaseAssociation_c[] targets, boolean loadComponent) {
		return getManyUC_EsOnR1210(targets, null, loadComponent);
	}
	public static Extend_c[] getManyUC_EsOnR1210(
			UseCaseAssociation_c[] targets, ClassQueryInterface_c test) {
		return getManyUC_EsOnR1210(targets, test, true);
	}
	...
	public static Extend_c[] getManyUC_EsOnR1210(
		...
		for (int i = 0; i < targets.length; i++) {
			Extend_c source = (Extend_c) targets[i].backPointer_IsSubtypeExtendIsSubtype_R1210;
			if (source != null && (test == null || test.evaluate(source))) {
				matches.add(source);
			}
		}
		if (matches.size() > 0) {
			Extend_c[] ret_set = new Extend_c[matches.size()];
	...
	public static Extend_c[] getManyUC_EsOnR1210(UseCaseAssociation_c target) {
		if (target != null) {
			UseCaseAssociation_c[] targetArray = new UseCaseAssociation_c[1];
			targetArray[0] = target;
			return getManyUC_EsOnR1210(targetArray);
		} else {
			Extend_c[] result = new Extend_c[0];
			return result;
		}
	}
	...
	public static Extend_c[] getManyUC_EsOnR1210(UseCaseAssociation_c target,
		...
		if (target != null) {
			UseCaseAssociation_c[] targetArray = new UseCaseAssociation_c[1];
			targetArray[0] = target;
			return getManyUC_EsOnR1210(targetArray, loadComponent);
		} else {
			Extend_c[] result = new Extend_c[0];
			return result;
		}
	...
	public static void batchRelateAll(ModelRoot modelRoot, boolean notifyChanges, boolean searchAllRoots, boolean relateProxies)
  {
    ...
    synchronized(instances) {
	    ...
	    {
            final Extend_c inst = (Extend_c)cursor.next() ;
	...
	public static Extend_c ExtendInstance(ModelRoot modelRoot,
			ClassQueryInterface_c test, boolean loadComponent) {
		Extend_c result = findExtendInstance(modelRoot, test, loadComponent);
			...
			for (int i = 0; i < pmcs.size(); i++) {
				...
				if (!component.isLoaded()) {
					try {
						...
						result = findExtendInstance(modelRoot, test,
								loadComponent);
						if (result != null)
							return result;
					} catch (Exception e) {
	...
	private static Extend_c findExtendInstance(ModelRoot modelRoot,
			ClassQueryInterface_c test, boolean loadComponent) {
		InstanceList instances = modelRoot.getInstanceList(Extend_c.class);
		synchronized (instances) {
			for (int i = 0; i < instances.size(); ++i) {
				Extend_c x = (Extend_c) instances.get(i);
	...
	public static Extend_c ExtendInstance(ModelRoot modelRoot,
			ClassQueryInterface_c test) {
		return ExtendInstance(modelRoot, test, true);
	}

	public static Extend_c ExtendInstance(ModelRoot modelRoot) {
		return ExtendInstance(modelRoot, null, true);
	}

	public static Extend_c[] ExtendInstances(ModelRoot modelRoot,
			ClassQueryInterface_c test, boolean loadComponent) {
		if (loadComponent) {
	...
	public static Extend_c[] ExtendInstances(ModelRoot modelRoot,
			ClassQueryInterface_c test) {
		return ExtendInstances(modelRoot, test, true);
	}
	public static Extend_c[] ExtendInstances(ModelRoot modelRoot) {
		return ExtendInstances(modelRoot, null, true);
	}

	public boolean delete() {
		boolean result = super.delete();
		boolean delete_error = false;
		String errorMsg = "The following relationships were not torn down by the Extend.dispose call: ";
		UseCaseAssociation_c testR1210Inst1 = UseCaseAssociation_c
		...
		if (delete_error == true) {
			...
			if (CorePlugin.getDefault().isDebugging()) {
				Ooaofooa.log.println(ILogger.DELETE, "Extend", errorMsg);
			} else {
				Exception e = new Exception();
				e.fillInStackTrace();
	...
	public static void checkClassConsistency(ModelRoot modelRoot) {
		Ooaofooa.log.println(ILogger.OPERATION, "Extend", //$NON-NLS-1$
				" Operation entered: Extend::checkClassConsistency"); //$NON-NLS-1$
		if (Boolean.valueOf(System.getenv("PTC_MCC_ENABLED")) == false) { //$NON-NLS-1$
			return;
		}
		Extend_c[] objs = Extend_c.ExtendInstances(modelRoot, null, false);
	...
	public boolean checkConsistency() {
		Ooaofooa.log.println(ILogger.OPERATION, "Extend", //$NON-NLS-1$
				" Operation entered: Extend::checkConsistency"); //$NON-NLS-1$
		if (Boolean.valueOf(System.getenv("PTC_MCC_ENABLED")) == false) { //$NON-NLS-1$
			return true;
		}
	...
	public void Dispose() {
		Ooaofooa.log.println(ILogger.OPERATION, "Extend",
				" Operation entered: Extend::Dispose");
	...
	public int Get_style(final int p_At) {
		Ooaofooa.log.println(ILogger.OPERATION, "Extend",
				" Operation entered: Extend::Get_style");
		final ModelRoot modelRoot = getModelRoot();
		if ((p_At == End_c.End)) {
	...
	public String Get_connector_text(final java.util.UUID p_Obj_id,
		...
		Ooaofooa.log.println(ILogger.OPERATION, "Extend",
				" Operation entered: Extend::Get_connector_text");
		final ModelRoot modelRoot = getModelRoot();
	...
	public java.util.UUID Get_ooa_id() {
		Ooaofooa.log.println(ILogger.OPERATION, "Extend",
				" Operation entered: Extend::Get_ooa_id");
		final ModelRoot modelRoot = getModelRoot();
		return getAssoc_id();
	...
	public String Get_name() {
		Ooaofooa.log.println(ILogger.OPERATION, "Extend",
				" Operation entered: Extend::Get_name");
		final ModelRoot modelRoot = getModelRoot();
		return "";
