...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/InstanceInspector.java
//
...
// class Instance_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'Instance_c' to provide 
 ...
 * </p>
 */
public class InstanceInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public InstanceInspector(MetadataSortingManager sortingManager){
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[8];
      ...
      attrSet[1] = new ObjectElement("Label", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getLabel"), arg, "getLabel", true);
      attrSet[1].setDerived();
      attrSet[2] = new ObjectElement("Default_Name", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getDefault_name"), arg, "getDefault_name", true);
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("InstanceOfClass.gif");
	}
