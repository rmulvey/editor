...
//====================================================================
//
// File:      com.mentor.nucleus.bp.core.InitialNode_c.java
//
...
abstract class EV_INITIAL_NODE extends genericEvent_c {
	public abstract int getEvtcode();
}

public class InitialNode_c extends NonRootModelElement
		implements
			IAdaptable,
			Cloneable {
	// Public Constructors
	public InitialNode_c(ModelRoot modelRoot, java.util.UUID p_m_id,
			String p_m_descrip) {
		super(modelRoot);
	...
	static public InitialNode_c createProxy(ModelRoot modelRoot,
		...
		InstanceList instances = modelRoot.getInstanceList(InitialNode_c.class);
		InitialNode_c new_inst = null;
		synchronized (instances) {
			Object[] key = {p_m_id};
			new_inst = (InitialNode_c) instances.get(key);
		}
		...
		if (new_inst == null) {
			...
			new_inst = new InitialNode_c(modelRoot, p_m_id, p_m_descrip);
			new_inst.m_contentPath = contentPath;
		}
		return new_inst;
	}

	static public InitialNode_c resolveInstance(ModelRoot modelRoot,
			java.util.UUID p_m_id, String p_m_descrip) {
		InstanceList instances = modelRoot.getInstanceList(InitialNode_c.class);
		InitialNode_c source = null;
		synchronized (instances) {
			Object[] key = {p_m_id};
			source = (InitialNode_c) instances.get(key);
		...
		InitialNode_c new_inst = new InitialNode_c(modelRoot, p_m_id,
				p_m_descrip);
		return new_inst;
	}
	public InitialNode_c(ModelRoot modelRoot) {
		super(modelRoot);
		m_descrip = "";
	...
	public boolean equals(Object elem) {
		if (!(elem instanceof InitialNode_c)) {
			return false;
		}
	...
	public boolean identityEquals(Object elem) {
		...
		InitialNode_c me = (InitialNode_c) elem;
	...
	public boolean cachedIdentityEquals(Object elem) {
		...
		if (!getIdCachedValue().equals(
				((InitialNode_c) elem).getIdCachedValue()))
			return false;
		return true;
	}
			...
			if (IsSupertypeControlNode != null) {
				...
				if (Boolean.valueOf(System.getenv("PTC_MCC_ENABLED")) == true) { //$NON-NLS-1$
					Ooaofooa.log
							.println(
									ILogger.CONSISTENCY,
									"InitialNode_c.relateAcrossR1106To(ControlNode_c target)",
									"Relate performed across R1106 from Initial Node to Control Node without unrelate of prior instance.");
				}
			}
	...
	public static InitialNode_c getOneA_INIOnR1106(ControlNode_c[] targets) {
		return getOneA_INIOnR1106(targets, null);
	}

	public static InitialNode_c getOneA_INIOnR1106(ControlNode_c[] targets,
			ClassQueryInterface_c test) {
		InitialNode_c ret_val = null;
		if (targets != null) {
			for (int i = 0; i < targets.length && ret_val == null; ++i) {
				ret_val = getOneA_INIOnR1106(targets[i], test);
			}
		}
	...
	public static InitialNode_c getOneA_INIOnR1106(ControlNode_c target) {
		return getOneA_INIOnR1106(target, null);
	}

	public static InitialNode_c getOneA_INIOnR1106(ControlNode_c target,
			boolean loadComponent) {
		return getOneA_INIOnR1106(target.getModelRoot(), target, null,
				loadComponent);
	}
	...
	public static InitialNode_c getOneA_INIOnR1106(ControlNode_c target,
			ClassQueryInterface_c test) {
		if (target != null) {
			return getOneA_INIOnR1106(target.getModelRoot(), target, test);
		}
		return null;
	}

	public static InitialNode_c getOneA_INIOnR1106(ModelRoot modelRoot,
			ControlNode_c target, ClassQueryInterface_c test) {
		return getOneA_INIOnR1106(modelRoot, target, test, true);
	}

	public static InitialNode_c getOneA_INIOnR1106(ModelRoot modelRoot,
			ControlNode_c target, ClassQueryInterface_c test,
			boolean loadComponent) {
		return find_getOneA_INIOnR1106(modelRoot, target, test);
	}
	private static InitialNode_c find_getOneA_INIOnR1106(ModelRoot modelRoot,
			ControlNode_c target, ClassQueryInterface_c test) {
		if (target != null) {
			InitialNode_c source = (InitialNode_c) target.backPointer_IsSubtypeInitialNodeIsSubtype_R1106;
	...
	public static InitialNode_c[] getManyA_INIsOnR1106(ControlNode_c[] targets) {
		return getManyA_INIsOnR1106(targets, null);
	}
	public static InitialNode_c[] getManyA_INIsOnR1106(ControlNode_c[] targets,
			boolean loadComponent) {
		return getManyA_INIsOnR1106(targets, null, loadComponent);
	}
	public static InitialNode_c[] getManyA_INIsOnR1106(ControlNode_c[] targets,
			ClassQueryInterface_c test) {
		return getManyA_INIsOnR1106(targets, test, true);
	}
	...
	public static InitialNode_c[] getManyA_INIsOnR1106(ControlNode_c[] targets,
		...
		for (int i = 0; i < targets.length; i++) {
			InitialNode_c source = (InitialNode_c) targets[i].backPointer_IsSubtypeInitialNodeIsSubtype_R1106;
			if (source != null && (test == null || test.evaluate(source))) {
				matches.add(source);
			}
		}
		if (matches.size() > 0) {
			InitialNode_c[] ret_set = new InitialNode_c[matches.size()];
	...
	public static InitialNode_c[] getManyA_INIsOnR1106(ControlNode_c target) {
		if (target != null) {
			ControlNode_c[] targetArray = new ControlNode_c[1];
			targetArray[0] = target;
			return getManyA_INIsOnR1106(targetArray);
		} else {
			InitialNode_c[] result = new InitialNode_c[0];
			return result;
		}
	}
	...
	public static InitialNode_c[] getManyA_INIsOnR1106(ControlNode_c target,
		...
		if (target != null) {
			ControlNode_c[] targetArray = new ControlNode_c[1];
			targetArray[0] = target;
			return getManyA_INIsOnR1106(targetArray, loadComponent);
		} else {
			InitialNode_c[] result = new InitialNode_c[0];
			return result;
		}
	...
	public static void batchRelateAll(ModelRoot modelRoot, boolean notifyChanges, boolean searchAllRoots, boolean relateProxies)
  {
    ...
    synchronized(instances) {
	    ...
	    {
            final InitialNode_c inst = (InitialNode_c)cursor.next() ;
	...
	public static InitialNode_c InitialNodeInstance(ModelRoot modelRoot,
			ClassQueryInterface_c test, boolean loadComponent) {
		InitialNode_c result = findInitialNodeInstance(modelRoot, test,
				loadComponent);
			...
			for (int i = 0; i < pmcs.size(); i++) {
				...
				if (!component.isLoaded()) {
					try {
						...
						result = findInitialNodeInstance(modelRoot, test,
								loadComponent);
						if (result != null)
							return result;
					} catch (Exception e) {
	...
	private static InitialNode_c findInitialNodeInstance(ModelRoot modelRoot,
			ClassQueryInterface_c test, boolean loadComponent) {
		InstanceList instances = modelRoot.getInstanceList(InitialNode_c.class);
		synchronized (instances) {
			for (int i = 0; i < instances.size(); ++i) {
				InitialNode_c x = (InitialNode_c) instances.get(i);
	...
	public static InitialNode_c InitialNodeInstance(ModelRoot modelRoot,
			ClassQueryInterface_c test) {
		return InitialNodeInstance(modelRoot, test, true);
	}

	public static InitialNode_c InitialNodeInstance(ModelRoot modelRoot) {
		return InitialNodeInstance(modelRoot, null, true);
	}

	public static InitialNode_c[] InitialNodeInstances(ModelRoot modelRoot,
			ClassQueryInterface_c test, boolean loadComponent) {
		if (loadComponent) {
	...
	public static InitialNode_c[] InitialNodeInstances(ModelRoot modelRoot,
			ClassQueryInterface_c test) {
		return InitialNodeInstances(modelRoot, test, true);
	}
	public static InitialNode_c[] InitialNodeInstances(ModelRoot modelRoot) {
		return InitialNodeInstances(modelRoot, null, true);
	}

	public boolean delete() {
		boolean result = super.delete();
		boolean delete_error = false;
		String errorMsg = "The following relationships were not torn down by the Initial Node.dispose call: ";
		ControlNode_c testR1106Inst1 = ControlNode_c.getOneA_CTLOnR1106(this,
				false);
		...
		if (delete_error == true) {
			...
			if (CorePlugin.getDefault().isDebugging()) {
				Ooaofooa.log.println(ILogger.DELETE, "Initial Node", errorMsg);
			} else {
				Exception e = new Exception();
				e.fillInStackTrace();
	...
	public static void checkClassConsistency(ModelRoot modelRoot) {
		Ooaofooa.log.println(ILogger.OPERATION, "Initial Node", //$NON-NLS-1$
				" Operation entered: Initial Node::checkClassConsistency"); //$NON-NLS-1$
		if (Boolean.valueOf(System.getenv("PTC_MCC_ENABLED")) == false) { //$NON-NLS-1$
			return;
		}
		InitialNode_c[] objs = InitialNode_c.InitialNodeInstances(modelRoot,
				null, false);
	...
	public boolean checkConsistency() {
		Ooaofooa.log.println(ILogger.OPERATION, "Initial Node", //$NON-NLS-1$
				" Operation entered: Initial Node::checkConsistency"); //$NON-NLS-1$
		if (Boolean.valueOf(System.getenv("PTC_MCC_ENABLED")) == false) { //$NON-NLS-1$
			return true;
		}
	...
	public void Dispose() {
		Ooaofooa.log.println(ILogger.OPERATION, "Initial Node",
				" Operation entered: InitialNode::Dispose");
	...
	public int Get_style() {
		Ooaofooa.log.println(ILogger.OPERATION, "Initial Node",
				" Operation entered: InitialNode::Get_style");
		final ModelRoot modelRoot = getModelRoot();
	...
	public int Get_text_style(final int p_At, final int p_Comp_num,
			final int p_Ent_num) {
		Ooaofooa.log.println(ILogger.OPERATION, "Initial Node",
				" Operation entered: InitialNode::Get_text_style");
		final ModelRoot modelRoot = getModelRoot();
		return Style_c.None;
	...
	public int Get_compartments() {
		Ooaofooa.log.println(ILogger.OPERATION, "Initial Node",
				" Operation entered: InitialNode::Get_compartments");
		final ModelRoot modelRoot = getModelRoot();
		return 0;
	...
	public int Get_entries(final int p_Comp_num) {
		Ooaofooa.log.println(ILogger.OPERATION, "Initial Node",
				" Operation entered: InitialNode::Get_entries");
		final ModelRoot modelRoot = getModelRoot();
		return 0;
	...
	public String Get_compartment_text(final int p_At, final int p_Comp_num,
			final int p_Ent_num) {
		Ooaofooa.log.println(ILogger.OPERATION, "Initial Node",
				" Operation entered: InitialNode::Get_compartment_text");
		final ModelRoot modelRoot = getModelRoot();
		return "";
	...
	public java.util.UUID Get_ooa_id() {
		Ooaofooa.log.println(ILogger.OPERATION, "Initial Node",
				" Operation entered: InitialNode::Get_ooa_id");
		final ModelRoot modelRoot = getModelRoot();
		return getId();
	...
	public String Get_name() {
		Ooaofooa.log.println(ILogger.OPERATION, "Initial Node",
				" Operation entered: InitialNode::Get_name");
		final ModelRoot modelRoot = getModelRoot();
		return "";
	...
	public boolean Incomingedgeallowed() {
		Ooaofooa.log.println(ILogger.OPERATION, "Initial Node",
				" Operation entered: InitialNode::Incomingedgeallowed");
		final ModelRoot modelRoot = getModelRoot();
		return false;
	...
	public boolean Outgoingedgeallowed() {
		Ooaofooa.log.println(ILogger.OPERATION, "Initial Node",
				" Operation entered: InitialNode::Outgoingedgeallowed");
		final ModelRoot modelRoot = getModelRoot();
		ActivityNode_c v_node = ActivityNode_c.getOneA_NOnR1105(ControlNode_c
				.getOneA_CTLOnR1106(this));
