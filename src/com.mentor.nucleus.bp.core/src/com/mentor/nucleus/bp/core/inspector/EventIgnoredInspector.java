...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/EventIgnoredInspector.java
//
...
// class EventIgnored_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'EventIgnored_c' to provide 
 ...
 * </p>
 */
public class EventIgnoredInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public EventIgnoredInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    StateEventMatrixEntry_c result1 = StateEventMatrixEntry_c.getOneSM_SEMEOnR504((EventIgnored_c)arg);
     if (result1 != null) {
        return result1;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("EventIgnored.gif");
	}
