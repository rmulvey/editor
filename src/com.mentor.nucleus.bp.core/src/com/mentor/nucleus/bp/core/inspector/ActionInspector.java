...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/ActionInspector.java
//
...
// class Action_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'Action_c' to provide 
 ...
 * </p>
 */
public class ActionInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public ActionInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    StateMachineState_c result1 = StateMachineState_c.getOneSM_STATEOnR511(MooreActionHome_c.getOneSM_MOAHOnR513(ActionHome_c.getOneSM_AHOnR514((Action_c)arg)));
     if (result1 != null) {
        return result1;
    }               
    Transition_c result2 = Transition_c.getOneSM_TXNOnR530(TransitionActionHome_c.getOneSM_TAHOnR513(ActionHome_c.getOneSM_AHOnR514((Action_c)arg)));
     if (result2 != null) {
        return result2;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[6];
      attrSet[0] = new ObjectElement("Suc_Pars", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getSuc_pars"), arg, "getSuc_pars", true);
      attrSet[1] = new ObjectElement("Action_Semantics", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getAction_semantics"), arg, "getAction_semantics", true);
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("StateAction.gif");
	}
