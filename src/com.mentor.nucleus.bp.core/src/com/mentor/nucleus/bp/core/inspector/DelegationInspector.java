...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/DelegationInspector.java
//
...
// class Delegation_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'Delegation_c' to provide 
 ...
 * </p>
 */
public class DelegationInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public DelegationInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Provision_c result1 = Provision_c.getOneC_POnR4009(InterfaceReference_c.getOneC_IROnR4013(InterfaceReferenceInDelegation_c.getOneC_RIDOnR4013((Delegation_c)arg)));
     if (result1 != null) {
        return result1;
    }               
    Requirement_c result2 = Requirement_c.getOneC_ROnR4009(InterfaceReference_c.getOneC_IROnR4013(InterfaceReferenceInDelegation_c.getOneC_RIDOnR4013((Delegation_c)arg)));
     if (result2 != null) {
        return result2;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("Delegation.gif");
	}
