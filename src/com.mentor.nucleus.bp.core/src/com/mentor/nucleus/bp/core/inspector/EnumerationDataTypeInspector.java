...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/EnumerationDataTypeInspector.java
//
...
// class EnumerationDataType_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'EnumerationDataType_c' to provide 
 ...
 * </p>
 */
public class EnumerationDataTypeInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public EnumerationDataTypeInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    DataTypePackage_c result1 = DataTypePackage_c.getOneS_DPKOnR39(DataTypeInPackage_c.getOneS_DIPOnR39(DataType_c.getOneS_DTOnR17((EnumerationDataType_c)arg)));
     if (result1 != null) {
        return result1;
    }               
    Package_c result2 = Package_c.getOneEP_PKGOnR8000(PackageableElement_c.getOnePE_PEOnR8001(DataType_c.getOneS_DTOnR17((EnumerationDataType_c)arg)));
     if (result2 != null) {
        return result2;
    }               
...
(EnumerationDataType_c)arg)
;



    sort(v_datatype);
    Enumerator_c [] v_enumerator = 
...
;
    ...
    for (int i = 0 ; i < v_enumerator.length ; i++) {   
        result.add(new ObjectElement("v_enumerator", ObjectElement.RELATION_ROLE_ELEMENT, v_enumerator[i], arg, false));
    }
...
;
    ...
    if (v_enumerator.length > 0) return true;
    return false;
  }
...
;
      if(VisibilityOwner != null) {
		   attrSet[0] = new ObjectElement("Visibility", ObjectElement.ATTRIBUTE_ELEMENT, invokeMethod(VisibilityOwner, "getVisibility"), arg, "getVisibility", true);
		   attrSet[0].setAttributeOwner(VisibilityOwner);
  	  }
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("Enumeration.gif");
	}
