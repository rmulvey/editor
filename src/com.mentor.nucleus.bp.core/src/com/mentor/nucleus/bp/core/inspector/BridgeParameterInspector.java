...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/BridgeParameterInspector.java
//
...
// class BridgeParameter_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'BridgeParameter_c' to provide 
 ...
 * </p>
 */
public class BridgeParameterInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public BridgeParameterInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Bridge_c result1 = Bridge_c.getOneS_BRGOnR21((BridgeParameter_c)arg);
     if (result1 != null) {
        return result1;
    }               
  ...
  public Object[] getReferentialDetails(Class<?> referentialClass, Object arg) {
	...
	if(details[0] == null && referentialClass == DataType_c.class) {
		details[0] = DataType_c.getOneS_DTOnR22(
(BridgeParameter_c)arg)
;
  ...
  */
  public ObjectElement[] getReferentials(Object arg) {
     List<ObjectElement> referentials = new ArrayList<ObjectElement>();
        Object referential = DataType_c.getOneS_DTOnR22(
(BridgeParameter_c)arg)
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("BridgeParameter.gif");
	}
