...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/ClassAsSupertypeInspector.java
//
...
// class ClassAsSupertype_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'ClassAsSupertype_c' to provide 
 ...
 * </p>
 */
public class ClassAsSupertypeInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public ClassAsSupertypeInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Association_c result1 = Association_c.getOneR_RELOnR201(ClassInAssociation_c.getOneR_OIROnR203(ReferredToClassInAssoc_c.getOneR_RTOOnR204((ClassAsSupertype_c)arg)));
     if (result1 != null) {
        return result1;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("Supertype.gif");
	}
