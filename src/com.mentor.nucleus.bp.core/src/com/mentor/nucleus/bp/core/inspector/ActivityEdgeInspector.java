...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/ActivityEdgeInspector.java
//
...
// class ActivityEdge_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'ActivityEdge_c' to provide 
 ...
 * </p>
 */
public class ActivityEdgeInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public ActivityEdgeInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Activity_c result1 = Activity_c.getOneA_AOnR1102((ActivityEdge_c)arg);
     if (result1 != null) {
        return result1;
    }               
    Package_c result2 = Package_c.getOneEP_PKGOnR8000(PackageableElement_c.getOnePE_PEOnR8001((ActivityEdge_c)arg));
     if (result2 != null) {
        return result2;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[6];
      attrSet[0] = new ObjectElement("Guard", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getGuard"), arg, "getGuard", true);
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("ActivityEdge.gif");
	}
