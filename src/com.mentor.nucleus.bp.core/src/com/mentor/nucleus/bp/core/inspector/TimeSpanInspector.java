...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/TimeSpanInspector.java
//
...
// class TimeSpan_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'TimeSpan_c' to provide 
 ...
 * </p>
 */
public class TimeSpanInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public TimeSpanInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    TimingMark_c result1 = TimingMark_c.getOneSQ_TMOnR941((TimeSpan_c)arg);
     if (result1 != null) {
        return result1;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("TimeSpan.gif");
	}
