...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/ComponentInstanceInspector.java
//
...
// class ComponentInstance_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'ComponentInstance_c' to provide 
 ...
 * </p>
 */
public class ComponentInstanceInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public ComponentInstanceInspector(MetadataSortingManager sortingManager){
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[13];
      attrSet[0] = new ObjectElement("Running", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getRunning"), arg, "getRunning", true);
      attrSet[1] = new ObjectElement("Next_Unique_ID", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getNext_unique_id"), arg, "getNext_unique_id", true);
      attrSet[2] = new ObjectElement("Next_Instance_ID", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getNext_instance_id"), arg, "getNext_instance_id", true);
      attrSet[3] = new ObjectElement("Label", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getLabel"), arg, "getLabel", true);
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("InstanceOfComponent.gif");
	}
