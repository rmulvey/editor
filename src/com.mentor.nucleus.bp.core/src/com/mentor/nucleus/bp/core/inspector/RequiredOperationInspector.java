...
//======================================================================
//
// File: com/mentor/nucleus/bp/core/inspector/RequiredOperationInspector.java
//
...
// class RequiredOperation_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'RequiredOperation_c' to provide 
 ...
 * </p>
 */
public class RequiredOperationInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public RequiredOperationInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Requirement_c result1 = Requirement_c.getOneC_ROnR4500(RequiredExecutableProperty_c.getOneSPR_REPOnR4502((RequiredOperation_c)arg));
     if (result1 != null) {
        return result1;
    }               
    ImportedRequirement_c result2 = ImportedRequirement_c.getOneCL_IROnR4703(ImportedReference_c.getOneCL_IIROnR4701(InterfaceReference_c.getOneC_IROnR4009(Requirement_c.getOneC_ROnR4500(RequiredExecutableProperty_c.getOneSPR_REPOnR4502((RequiredOperation_c)arg)))));
     if (result2 != null) {
        return result2;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("RequiredOperation.gif");
	}
