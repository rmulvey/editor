...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/canvas/inspector/FillcolorstyleInspector.java
//
...
// class Fillcolorstyle_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'Fillcolorstyle_c' to provide 
 ...
 * </p>
 */
public class FillcolorstyleInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public FillcolorstyleInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Model_c result1 = Model_c.getOneGD_MDOnR402(Elementstyle_c.getOneSTY_SOnR400((Fillcolorstyle_c)arg));
     if (result1 != null) {
        return result1;
    }               
    Shape_c result2 = Shape_c.getOneGD_SHPOnR2(GraphicalElement_c.getOneGD_GEOnR401(Elementstyle_c.getOneSTY_SOnR400((Fillcolorstyle_c)arg)));
     if (result2 != null) {
        return result2;
    }               
    Connector_c result3 = Connector_c.getOneGD_CONOnR2(GraphicalElement_c.getOneGD_GEOnR401(Elementstyle_c.getOneSTY_SOnR400((Fillcolorstyle_c)arg)));
     if (result3 != null) {
        return result3;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("metadata/FillColor.gif");
	}
