...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/canvas/inspector/FloatingTextInspector.java
//
...
// class FloatingText_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'FloatingText_c' to provide 
 ...
 * </p>
 */
public class FloatingTextInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public FloatingTextInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Shape_c result1 = Shape_c.getOneGD_SHPOnR27((FloatingText_c)arg);
     if (result1 != null) {
        return result1;
    }               
    Connector_c result2 = Connector_c.getOneGD_CONOnR8((FloatingText_c)arg);
     if (result2 != null) {
        return result2;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[5];
      attrSet[0] = new ObjectElement("end", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getEnd"), arg, "getEnd", true);
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("metadata/FloatingText.gif");
	}
