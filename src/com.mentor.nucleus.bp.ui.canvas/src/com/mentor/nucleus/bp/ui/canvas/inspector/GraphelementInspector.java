...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/canvas/inspector/GraphelementInspector.java
//
...
// class Graphelement_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'Graphelement_c' to provide 
 ...
 * </p>
 */
public class GraphelementInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public GraphelementInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Shape_c result1 = Shape_c.getOneGD_SHPOnR19(Graphnode_c.getOneDIM_NDOnR301((Graphelement_c)arg));
     if (result1 != null) {
        return result1;
    }               
    FloatingText_c result2 = FloatingText_c.getOneGD_CTXTOnR19(Graphnode_c.getOneDIM_NDOnR301((Graphelement_c)arg));
     if (result2 != null) {
        return result2;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("metadata/GraphElement.gif");
	}
