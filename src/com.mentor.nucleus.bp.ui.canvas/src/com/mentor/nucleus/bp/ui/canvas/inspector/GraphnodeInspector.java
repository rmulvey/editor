...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/canvas/inspector/GraphnodeInspector.java
//
...
// class Graphnode_c from the traversal mechanisms that it provides to
// model diff.
//
...
/**
 * This file adapts the meta-model entity; 'Graphnode_c' to provide 
 ...
 * </p>
 */
public class GraphnodeInspector extends BaseModelClassInspector {

  private String parentAssoc;
  
  public GraphnodeInspector(MetadataSortingManager sortingManager){
  ...
  public Object getParent(Object arg) {
    Shape_c result1 = Shape_c.getOneGD_SHPOnR19((Graphnode_c)arg);
     if (result1 != null) {
        return result1;
    }               
    FloatingText_c result2 = FloatingText_c.getOneGD_CTXTOnR19((Graphnode_c)arg);
     if (result2 != null) {
        return result2;
    }               
  ...
  */
  public ObjectElement[] getAttributes(Object arg) {
    ObjectElement attrSet[] = new ObjectElement[3];
      attrSet[0] = new ObjectElement("width", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getWidth"), arg, "getWidth", true);
      attrSet[1] = new ObjectElement("height", ObjectElement.ATTRIBUTE_ELEMENT,  invokeMethod(arg, "getHeight"), arg, "getHeight", true);
    ...
    public Image getImage(Object element) {
		...
		return CorePlugin.getImageFor("metadata/GraphNode.gif");
	}
